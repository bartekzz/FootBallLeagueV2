...
# Database: league
# Generation Time: 2017-10-26 04:27:21 +0000
# ************************************************************
...
CREATE TABLE `result` (
  ...
  CONSTRAINT `result_ibfk_1` FOREIGN KEY (`game_id`) REFERENCES `game` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `result` WRITE;
/*!40000 ALTER TABLE `result` DISABLE KEYS */;

INSERT INTO `result` (`id`, `team1_score`, `team2_score`, `game_id`)
VALUES
	(993,3,3,26),
	(994,4,5,27),
	(995,4,2,28),
